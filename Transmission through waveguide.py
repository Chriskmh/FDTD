...
episilon = np.ones((SizeX ,SizeY))
episilon[0:SizeX,70:80] = episilon_Si
...
for time in range(MaxTime):
    ...
    Dz[1:SizeX-1,1:SizeY-1] = Cx_neg[1:SizeX-1,1:SizeY-1]/Cx_pos[1:SizeX-1,1:SizeY-1]*Dz[1:SizeX-1,1:SizeY-1] + dt/episilon[1:SizeX-1,1:SizeY-1]/Cx_pos[1:SizeX-1,1:SizeY-1]*((Hy[1:SizeX-1,1:SizeY-1]-Hy[0:SizeX-2,1:SizeY-1])/dy-(Hx[1:SizeX-1,1:SizeY-1] - Hx[1:SizeX-1,0:SizeY-2])/dx)
    ...
    # Generate source 
    Ez[25,75] = Ez[25,75] + dt*Source(time)
    ...
    # Record Ez at the time timestep = 1.5e3
    if time == int(1.5e3):
        Ez_1_5e3[:,:] = Ez[:,:]
...
# Plot Ez at timestep = 1.5e3
def plot_Ez_1_5e3():
    fig = plt.figure()
    ax2 = fig.add_subplot(111,projection='3d')
    ax2.plot_surface(X, Y, Ez_1_5e3,cmap='coolwarm')
    ax2.set_xlabel('X')
    ax2.set_ylabel('Y')
    ax2.set_title('Ez at time timestep = 1.5e3')
    plt.show()
